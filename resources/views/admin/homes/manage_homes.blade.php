...
<div class="tab">
  <button class="tablinks active" onclick="openMode(event, 'homes')">Homes</button>
  <button class="tablinks" onclick="openMode(event, 'features')">Features</button>
</div>
 <div id="homes" class="tabcontent" style="display: block;"><br><br>
 <div class="row">
   @foreach($homes as $home)
      <div class="col-md-3">
        ...
        <div class="col-md-6">
          <div class="container details" style="text-align: center;">
        ...
        <div class="col-md-2">
        <a type="button" href="/admin/home/edit/14" style="font-size: 15px;" class="btn btn-info">Edit</a>
        </div>
        @endforeach
      </div>
</div>
...
<div id="features" class="tabcontent"><br><br>
  <div class="container">
  <br>
    <div class="row">
      <div class="col-md-4">
        <a type="button" data-toggle="modal" data-target="#feature_edit" style="font-size: 15px; background-color:#18BDB0;" class="btn btn-Success">Add New Feature</a>
      </div>
      <div class="col-md-4">
...
<!-- Modal -->
<div class="modal fade" id="feature_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="AddFeature" tabindex="-1" role="dialog" aria-labelledby="add_feature" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="add_feature">Features</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
