...
<div class="col-md-2">
<a type="button" href="/edit_homes" style="font-size: 15px; background-color:#18BDB0;" class="btn btn-Success">Add New</a>
</div>
</div>
<br>
    <div class="row">
      ...
      <div class="col-md-4" >
        <div class="card">
          ...
          <h5 class="card-title" style="font-size: 15px;">{{$home->title}}</h5>
             ...
             <div class="row">
            <div class="col-md-3">
            <a type="button" href="/admin/home/edit/{{$home->id}}" id="" style="font-size: 15px;" class="btn btn-primary">Edit</a>
             </div>
             <div class="col-md-4">   
