...
<div class="col-md-2">
<a type="button" data-toggle="modal" data-target="#editavail" style="font-size: 15px; background-color:#18BDB0;" class="btn btn-Success">Add New</a>
</div>
</div>
<br>
    <div class="row">
      <div class="col-md-4" >
        <div class="card">
          ...
          <div class="card-body">
             ...
             <div class="row">
            <div class="col-md-3">
             <a type="button" href="" data-toggle="modal" data-target="#editavail" style="font-size: 15px;" class="btn btn-primary">Edit</a>
             </div>
             <div class="col-md-4">
  ...
  <div class="modal fade" id="editavail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
